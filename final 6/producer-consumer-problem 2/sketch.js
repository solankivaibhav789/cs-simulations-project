...
function draw() {
	...
	textSize(20);
	fill(249, 13, 4);
	rect(700,height-50,40,40);
	fill(7,255,255);
	rect(700,height-100,40,40);
	
	fill(255);
	text(" - available for do process",750,height-70);
	text(" - goes to sleep",750,height-20);
	pop();
...
function drawName()
{
	...
	fill(7,255,255);
	textSize(20);
	text("press produce or consume button for produce or consume item respectively",20,height-20);
	pop();
}
